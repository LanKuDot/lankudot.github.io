var store = [{
        ...
        "teaser": "/assets/images/blog/2023/2023-01-08-this-is-sengoku-period/cover-image.JPG"
      },{
        "title": "[筆記] 重構專案中的舊元件",
        ...
        "teaser": "/assets/images/blog/2023/2023-01-30-refactor-legacy-component-in-project/refactor-is-like.jpg"
      },{
        "title": "[宣傳] 空氣魚實驗室",
        ...
        "teaser": "/assets/images/blog/2023/2023-03-26-airfishlab-promotion/logo.png"
      },{
        ...
        "teaser": "/assets/images/blog/2023/2023-04-18-kons-tone/cover-image.png"
      },{
        ...
        "teaser": "/assets/images/blog/2023/2023-08-12-gutenbergs-apprentice/cover-image.jpg"
      },{
        "title": "[閱讀] 小島秀夫《創作的基因》",
        ...
        "teaser": "/assets/images/blog/2023/2023-10-07-the-gifted-gene-and-my-lovable-memes/cover-image.jpg"
      },{
        ...
        "teaser": "/assets/images/blog/2023/2023-11-05-dive-into-font-design-in-train-station/cover-image.jpg"
      },{
        ...
        "excerpt":"當回憶可以被「裝幀」到書中，自此忘卻這段痛苦的經歷，從而開始新的人生，對一個人來說或許是救贖。但如果被有心人用來裝幀受害者的回憶，抑或是這些不想記起的回憶成為收藏家的玩物時，這童話故事般的能力對被裝幀的人來說是慈悲與救贖，還是自私與痛苦。      主角艾墨特天生擁有裝幀師的能力，但是生長的地方卻把書視為詛咒之物，碰到書只有挨打的份。然而艾墨特生了一場重病，才發現患有「裝幀師熱」，家人在萬般不願意之下，只能將他送到裝幀所當學老裝幀師ー瑟芮狄絲ー的學徒。雖然艾墨特在成為學徒後，症狀逐漸改善，瑟芮狄絲卻遲遲不教導他關於「裝幀」的技術。隨著日子推移，艾墨特發病時會夢到的景象也越來越清晰，然而卻發現這個夢似乎是解答自己遭遇的關鍵，這背後隱藏著更大的事件。   一個故事讓人想要繼續閱讀，就是因為有許多問號等著解答。在知道解答時，會有種「原來是這樣啊」的感覺，但《裝幀師》在解答問題的時候，則是讓人有「什麼！居然是這樣」的感覺。意識到原來前面只知道真相的一半，對劇情的認知是錯的，每個人物看似平常的行為，其實背後都是有原因的。當初進入解答的篇章時，還一直來回對照前面的劇情，看得速度也越來越快，就是希望快點知道整個事件的全貌。   《裝幀師》故事分成三個篇章，鋪陳與事件篇、解答篇、解決篇，個人覺得解答篇是全書的高潮，但進入解答篇之前放的劇情高點更是畫龍點睛，從這裡才意識到「有什麼認真的要來了」。而解決篇也很有趣，是從另一個人的觀點繼續把故事延續下去，同時也在收束前面的伏筆。在看之前，原本以為《裝幀師》是奇幻故事，看了才發現是一個充滿人心黑暗的故事。  ","categories": ["blog"],
        "tags": ["閱讀","心得"],
        "url": "/blog/2024-07-the-binding/",
        "teaser": "/assets/images/blog/2024/2024-07-07-the-binding/cover-image.jpg"
      },{
        "title": "[遊記] 來去逛逛 2024 BitSummit",
        "excerpt":"去年 9 月逛了東京電玩展之後，就決定今年要來日本最大的獨立遊戲展ーBitSummit。BitSummit 每年夏天固定在京都市勸業館舉辦，為期三天，吸引世界各地的開發者與發行商來參加。而今年舉辦在 7/19 ~ 7/21（第一天為商務日），副標題為「Drift」。 勸業館地點就位在平安神宮附近，搭公車就可以抵達。一般入場票為 2000 日圓，門票在一般公開日的這兩天都可以入場，要事先在網路上購票，再到日本的 7-11 請店員把票券印出來，而現場也有販售當日門票。參觀時間從早上 10 點到下午 5 點，以體驗來說算是相當超值。這次會場在場館的一樓與三樓，一樓攤位有合作夥伴、學校、桌遊、Game Jam 發表等，而三樓攤位則有主舞台、開發者、發行商等。這次跟同行友人主要目標就是三樓的攤位。 搭公車的話，就會看到平安神宮的巨大鳥居 來現場的好處一個是可以先玩到還沒發售的遊戲，另一個就是可以跟開發者交流了。交流語言的話，體感英文 7 成，日文 3 成，當然也有會中文的開發者。話題的部份，可以聊聊遊戲開發了多久、用什麼遊戲引擎開發、當初是怎麼開始的等，或是自己喜歡遊戲的哪個部份或機制，開發者都很樂意分享自己的經驗，或是接受玩家的意見。我在這過程中，才後悔自己的英文能力怎麼那麼差，不能順利表達自己有多喜歡他們的遊戲，這次回來要多多加強口說能力了:laughing:。 這次在會場先玩到一直有在關注的《MOTIONREC》 這兩天下來，也試玩了十幾款遊戲，因為個人喜好大多是解謎類的遊戲。像是以錄製角色移動路徑，再播放路徑讓角色移動到原本無法到達的地方的《MOTIONREC》。自己是顆易碎的蛋，要怎麼安全地跳到高處，或是下降到低處的《Fowl Damage》。還有非常喜歡日本工學院專門學校蒲田校的遊戲設計科的兩款遊戲：一個是結合倉庫番與光與影，透過移動箱子與光源，利用箱子的陰影在上方形成平台，讓影之貓可以抵達目標門的《迷暗》。另一個是透過複製一部份區域，來取代另一部份區域，以開啟不能通過的地方的《うつルーム》。同行友人與開發者聊過之後，才知道他們是直接以 C++ 寫成遊戲，物理碰撞也都是自己寫的，真心佩服。 由學生製作的《迷暗》與《うつルーム》除了機制很吸引人之外，關卡設計也很用心 會場空間不會太擁擠，在開發者區就算兩側有人排隊，中間還是有足夠空間讓一個人通過，整天逛下來很舒服。而且很多攤位有準備二台以上的試玩設備，所以如果當下想玩的遊戲需要等待的話，先去逛其它攤位再回來都還有機會玩到。另外在一樓入場後，會拿到一個主辦發的提袋，最大可以裝下 A4 L 夾，拿來裝各家文宣相當方便，不用擔心折到，也可以不用在試玩時，煩惱要如何暫放文宣品。比較可惜的是，現場並沒有宣傳袋子中有可以拿來投最喜歡遊戲的貼紙，位在三樓的投票板上的貼紙數很少，而且如果直接到三樓會場的話，也不會拿到袋子。開發《迷暗》的學生說如果有拿到人氣獎的話，就有機會出版了，感到有點可惜。 最後飲食的部份，在一樓會場內有食物攤，會場外也有餐車，附近只有一間小小的全家。午餐時間人很多，在外面排食物也很熱。如果本來就打算一整天就在會場，建議事先就買好午餐跟飲料。 BitSummit 逛完不妨到平安神宮參拜 喜歡獨立遊戲的話，BitSummit 非常值得來逛一次，可以感受到來自世界各地的開發者的熱情，很有「祭典」的氛圍。會後也公布了 2025 年的 BitSummit 在 7/18 ~ 7/20 舉辦，副標題為「XIII」，也呼應下一次是第十三屆。而這時間也恰逢日本三大祭之一「祇園祭」的期間，有機會的話，不妨安排一趟京都之旅。 HOT NEWS (literally)...","categories": ["blog"],
        "tags": ["遊記","遊戲展"],
        "url": "/blog/2024-08-visit-bitsummit/",
        "teaser": "/assets/images/blog/2024/2024-08-03-visit-bitsummit/cover-image.jpg"
      },{
        "title": "[雜談] 理想與現實：大公司的價值觀洗禮",
        "excerpt":"之前工作參與的專案規模不大，或是能切分出互不影響的功能，讓每個人各自負責，所以程式功能只要顧好自己的部份就好。在進入大公司後，專案規模變大，開發勢必得要多人一起進行。然而一人開發與多人開發的情景完全不同，大公司專案專注的面向也不一樣，理所當然，就面臨了不少價值觀的衝擊。      程式風格混亂   起初專案並沒有明確規範程式風格，也沒有進行 code review，造成專案中充斥著不同的程式風格。然而專案為了方便維護程式碼，即使那個是不好的風格，還是被要求跟著該功能既有的程式風格撰寫程式。   剛加入專案那時，一直苦惱縮排到底是用 tab 還是 space，一行 200 字元的程式碼要不要幫忙換行，或是巢狀階層多到可以打波動拳了，要不要拆出函式等。起先在加新功能的時候，我會順手改掉原本程式碼中不好的風格。但後來被阻止了，原因是如果該功能出錯，會找最後一個改動的人負責任。直到這個問題變成技術債之後，專案才開始重視程式風格，慢慢明確規範程式寫法。想想如果當初在修改前，先跟主管提出程式風格的問題的話，應該可以提前重視這個問題。    程式碼風格不一致讓人無所適從   在多人開發專案中，能有統一的程式風格相當重要，即使那個功能不是自己開發的，也能快速理解功用。另外現今編輯器可以設定程式風格的檢查，包含強制換行、變數命名格式、縮排、行尾空白等。更嚴格一點還可以搭配 git hook，只要不合規範，就不能推上去。   功能先有最重要   因為專案的性質，需要定期推出新功能，因此功能能否即時上線是最重要的，程式碼寫得好不好並不重視。加上能開發的時間不足，為了追趕時程，也為了不影響既有的功能，只能省略架構設計，直接參考既有的程式碼撰寫，或甚至直接複製一份出來改，最慘的是連驗證的時間都不足。雖然功能即時上線了，但品質卻脆弱不堪。   用這個方式開發的後果就是增加後續維護的難度。同一個功能被複製了好幾份，修了其中一份的 bug 後，才發現其他地方還有相同的 bug。或是要更新某個功能時，得要找出所有複製出來的功能一併修改。為了追趕一個又一個的上線時程，這樣的技術債只會越堆越高。現在省下來的時間，後來就加倍還回去了。    趕時間開發的功能最後帶來解不完的 bug   理想的開發模式是先規劃好功能需要哪些元件，元件之間要如何互動，再去撰寫程式碼。如果是在既有功能上製作，則要再加上理解原本架構的部份。然而要能執行這樣的開發模式，除了得有足夠的開發時間，更重要的是要有健康的專案架構。但現實是專案過了好幾手之後，功能相互交雜，牽一髮而動全身。為了避免擴大麻煩，繞過原本的功能去做新功能反而是最保險的作法。   重構永遠是最後選項   開發新功能時，原有的架構不敷需求的話，就一定需要重構，然而對上線的功能來說「能動的就不要動」，要重構就得要冒著既有功能壞掉的風險。當開發與驗證時間不足的時候，想要重構也無能為力，就會出現前面所說的，只能繞路或是擱置問題。   只是當技術債累積到不得不面對的程度，就還是得進行重構。在參與專案的期間負責過兩次大型重構，當時各花兩個月在上面：一次是因為某個底層功能太複雜，以致於影響執行效能；另一次是幾個重要機制被複製了數次，為了讓即將開發的新功能也能使用那些機制，與後續方便維護，把它們整理出來，作為共用功能。    技術債終究是要還的   無論重構規模的大小，只要有重構就得驗證所有相關的功能是否正常。重構前先確認影響的範圍，如果影響範圍太大，就得思考拆分重構的規模，一次只重構一部分。好處是容易掌握需要驗證的功能，出 bug 時容易找到出問題的地方。另外重構時，通常專案也在開發，能儘早把重構後的功能合併回專案的話，也能避免該功能仍然以舊方法開發，造成還要再度重構。   還是有收穫   不過參與大公司的專案可以體驗到單人專案無法體驗的事情，其中之一是可以跟其它程式交流。當不知道功能如何設計比較好時，就可以詢問其它程式的意見，往往會得到不錯的想法。另外 code review 也是很適合交換意見的時候，除了可以分享自己的做法與建議之外，也可以看到其它人的思維，做為未來寫程式時的參考。   另外一個就是可以訓練溝通能力。在多人專案中，當遇到不是自己做的功能，就得要詢問當初做或比較熟那個功能的人。雖然可以靠自己閱讀程式碼來理解，但如果先問相關的程式碼與執行流程，反而更能快速上手，也更能專注在要實作的功能上。反之亦然，其它人也會來問自己做的功能，能夠清楚地解釋自己的程式碼，也是很實用的能力。    能學習跟其它人溝通是最大的收獲   除了跟程式討論之外，也會時常跟不同部門的人討論。對方詢問問題時，得先釐清真正想問的內容，最好是能將自己理解的問題內容講給對方聽，確認理解的是不是一樣的。另一方面，也盡量以對方能理解的方式講解。否則很常雞同鴨講，最後搞得雙方都很混亂。   生於憂患   總覺得在體驗過什麼是不好的之後，才知道什麼是好的。在這段時間中，確實是挺煎熬的過程，但也是在這樣環境中才開始思考為什麼這樣的情況是不好的，以及如何改善這樣的情況。如果能帶到下一個可以發揮的環境的話，會是很好的養份。  ","categories": ["blog"],
        "tags": ["雜談"],
        "url": "/blog/2024-12-work-experience-in-big-company/",
        "teaser": "/assets/images/blog/2024/2024-12-02-work-experience-in-big-company/ideal-vs-reality.png"
      },{
        "title": "[分享] 2025 亞太遊戲高峰會 -《聖騎士之戰 -奮戰-》的全球化挑戰",
        "excerpt":"在台北電玩展舉行期間，也會同時進行亞太遊戲高峰會。高峰會邀請遊戲業相關商業人士前來分享經驗，議題涵蓋開發、技術、行銷、社群推廣等。不過對我來說，與其說是去聽演講，不如說是粉絲見面會。而今年最有興趣的演講之一是 GGST 的製作人宮內健的分享，在這場演講中也獲益良多，所以用這篇文章來分享演講的內容。 製作人宮內健在這場演講中主要分享在開發《聖騎士之戰 -奮戰-》（GGST）中，為了能吸引新玩家，又要兼顧舊玩家，所做的改變以及面臨的問題。 格鬥遊戲的困境 以往格鬥遊戲給人難度很高的印象，緒如只要逮到就會被連段到底，無法反擊、招式又多又複雜、需要即時反應以應對場上情況。造成格鬥遊戲很難吸引新玩家，也有玩家年齡越來越高的趨勢。在 GGST 一次封測的問券調查中，有前作遊玩經驗的人高達約 95%，而且這當中有約 74% 是 25 歲以上的玩家，而剩下的 5% 沒玩過的人中，有約 60% 是 25 歲以下的玩家。為了能讓續作繼續下去，吸引新玩家變得很重要。 內外在進行改變 為了能夠吸引新玩家，在 GGST 的外在與內在都做了改變。外在的部份是讓遊戲畫面變得乾淨，該玩家容易搞清楚場上發生的狀況。內在則是不用連段或是必殺技就可以打出高傷或是華麗的招式，而在角色的攻略影片中也避免給連段的攻略，讓玩家覺得這種程度的控制我也可以。 與前作相比，GGST 的介面變得簡潔。上圖擷圖來源，下圖擷圖來源 在官方的角色攻略影片中介紹單招及簡單的指令 注重線上對戰 在對戰環境上也要順應線上對戰變為主流的趨勢。日本的機廳文化較為盛行，習慣面對面的對戰，所以線下的本地對戰容易進行。但是在美國地域廣大，要進行線下對戰就得長途跋涉。在線上的部份，網路狀態好的地方也相對有優勢，但美國的網路在各地也有差別。然而玩家比較喜歡找到同樣程度的人對戰，如果對戰一面倒的話，贏家沒有成就感，輸家也會覺得遊戲太難，因而留不住玩家。因此在 GGST 中也導入 Rollback Netcode，它可以讓網路環境不好的玩家也能有順暢的遊戲體驗，在疫情期間舉辦的線上賽也獲得好評。 Rollback Netcode 在收到下個指令之前，先假設玩家沒有改變輸入的指令，直到收到下個指令。如果跟預測一樣，就不改變角色的行為，如果不一樣，則柔順地將角色轉到對應的動作。避免以往沒收到指令角色就不動作所造成的卡頓感 現代化的角色形象 再來就是角色外觀的喜好也在改變，而且歐美人覺得美少女互歐是一件很奇怪的事情。因此在 GGST 中讓角色的視覺形象現代化，只保留覺得「很酷」的元素，也在角色年齡與服裝上做改變。而在劇情中加入對應的故事，讓角色的改變合理化。 可以看到 May 與 Dizzy 這兩個角色在前作 GGXrd 與續作 GGST 的形象改變，服裝也以日常服為為主，但還是保留主要元素 與老玩家溝通...","categories": ["blog"],
        "tags": ["分享"],
        "url": "/blog/2025-01-2025-apgs-ggst-share/",
        "teaser": "/assets/images/blog/2025/2025-01-30-2025-apgs-ggst-share/ggst-cover-image.jpg"
      },{
        "title": "[電影] 2024 看過的那些電影們",
        "excerpt":"去年因為工作變得比較繁重，所以電影看的不多，不過這樣反而可以寫得比較詳細。為了篇幅，就簡單分成真人電影與動畫電影兩篇，這篇就記錄真人電影的部份。去年最喜歡的電影就是《沙丘：第二部》了，去二刷的時候還選了 IMAX 的版本，對於太空科幻的題材真的愛不釋手啊。   沙丘：第二部      被哈肯能家族襲擊，失去駐地與家人的保羅．亞崔迪加入史帝加帶領的弗瑞曼人部族後，開始集結弗瑞曼人組織對抗哈肯能家族的行動。同時保羅的母親潔西嘉女士，也利用貝尼．潔瑟睿德姐妹會事先散佈的預言以及弗瑞曼人的信仰，將保羅塑造成救世主，以獲取弗瑞曼人的支持。而哈肯能家族在奪回厄拉科斯的主導權後，繼續以往的香料採收事業，但弗瑞曼人則利用遊擊戰術破壞哈肯能人的設備以干擾採收。哈肯能男派出心狠手辣的侄子菲得．羅薩，前往厄拉科斯剷除弗瑞曼人。   我很喜歡太空科幻中，用宗教、文化、儀式、服裝來帶出一個種族或勢力的個性與特色。像是哈肯能家族的母星羯地主星上，人民都是光頭，穿著黑色長袍，也有著獨特的歡呼手勢。為了慶祝菲得的生日，則是在鬥技場中讓他獵殺三名亞崔迪家的俘虜。再再顯示哈肯能家是邪惡的好戰勢力。不過菲得登場的這場戲，也是我喜歡的片段之一，為了還原羯地主星所在的星系的太陽是發出紅外線光，導演特別用紅外線攝影機來拍攝，讓畫面呈現都是黑白色的。相比 1984 年《沙丘魔堡》電影裡的菲得是瘋瘋巔巔的殺手，這版的菲得顯得冷酷多謀，很有反派魅力。   保羅與菲德的一對一最終決戰也相當精彩，沒有過份的晃動鏡頭，可以很清楚地理解發生了什麼事。看了幕後花絮知道他們都為了戲中的打鬥練習了很多，也才知道在鬥技場跟菲得打到最後的那名演員就是本片的武術指導。當然最終保羅贏得勝利，在獲得漠大的權力後，準備向宇宙的氏族宣戰，然而此舉讓卻保羅的心上人荃妮感到生氣又失望，同時保羅夢到的聖戰已經被觸發。   GT：跨界玩家      《GT：跨界玩家》是真人真事改編的電影，主角揚從小就迷上《Gran Turismo》，並且夢想成為一名職業賽車手。有一天在遊戲賽道上創下的最佳記錄，讓他獲得參加由 Nissan 與遊戲開發商共同舉辦的「GT 學院」的機會。這個學院聚集了 8 位頂尖玩家，並把他們培養成職業賽車手，最後篩選出 1 位來參加他們的車隊。這對於一直被家人反對玩遊戲的揚來說，無疑是可以證明自己的機會。   雖然這類電影可以知道主角的結果，但是過程怎麼發展才是電影的重點，與家人的衝突、訓練的艱苦、被職業選手看輕，一再地為主角的成功加上更多的份量，也知道這結果得來不易。電影的賽車畫面也都是實車實地拍攝，就為了給觀眾最真實的比賽體驗，而故事的真人揚也在電影中擔任特技替身。比較可惜的是賽車中的畫面不夠長，經常在人物跟賽車間切換，看得不夠過癮。《Gran Turismo》也是我第一款接觸的賽車遊戲，所以得知這部電影時，就一直有興趣。但上映那時沒有時間到電影院觀看這部電影，直到在 Netflix 上架，才有機會補完，看完覺得如果當初能到電影院體驗引擎的轟隆聲，那感覺一定很棒。   秘境探險      《秘境探險》是同名遊戲的改編電影，主角奈森流著探險家的血液，原本在酒吧擔任酒保的他，遇到寶藏獵人蘇利文告訴他正在尋找埋藏的黃金，而原本的合伙人就是奈森的哥哥ー山姆。山姆在奈森小時候，為了不想被因為多次闖入博物館偷東西被關而逃離孤兒院，雖然當時約好會回來找奈森，但是這個承諾一直沒有兌現。做為幫助蘇利文，同時為了尋找哥哥山姆的下落，奈森踏上這趟尋寶旅程。   做為尋寶冒險電影，肯定少不了謎題、陷阱、覬覦同個寶藏的壞人與同夥的背叛。只是可惜的是，覺得這部電影對這些要素只是把它放進去，但沒有加深刻劃。劇情的走向可以猜得到，但也沒有意外的發展。像是敵人可以找到最後的埋藏點，只是因為剛好看到主角開船往那個方向移動，雖然可以合理解釋為什麼敵人可以到達那邊，但就是選了個最普通的原因。最驚喜的反而是彩蛋，像是遊戲制作公司頑皮狗的貼紙、遊戲中奈森的真人演員諾蘭也有參一腳。另外就是當主角奈森無意戴上腋下槍套背帶，成為遊戲中的造型時，更是令人興奮。   小丑：雙重瘋狂      原本以為作為《小丑》的續作，再加上「雙重瘋狂」的副標題，覺得這次應該是要開始讓高譚市瘋狂了，然而整部電影就只有「亞瑟」沒有「小丑」。每當你以為亞瑟要開始瘋狂、情緒要爆發的時候，亞瑟就退縮了，說其實自己沒有想要成為小丑，電影看完只留下壓抑的感受。   不過滿喜歡電影前半的部份，使用歌舞做為小丑的內心幻想或是情緒延續。歌曲用在美國脫口秀中由 house band 演奏的那類爵士樂，搭配戲謔的歌詞，以及一直在背景的不協調單音。雖然充滿脫口秀的那種戲謔歡樂氣氛，但不協調的單音也帶著壓抑感，彷彿說著這一切只不過是個「Joke」。但是這種穿插歌舞表演的形式到了後半反而變成一種濫用，一到需要表達內心情感的時候，就開始唱歌，反而相當破壞節奏，甚至覺得有點煩燥。不知道是不是為了配合 Lady Gaga，才用歌舞表演的形式呈現。只是具體地把情感用歌詞唱出來，反而覺得有點多此一舉，畢竟不是所有情緒表現都適合用歌舞呈現。不過在只有小丑的幾場戲中，瓦昆還是有只用演出，就把小丑的內心狀態直接帶給觀眾，當下覺得瓦昆的演技真的很厲害。   從劇情來看，這版的小丑不會是以往大家對小丑的印象，雖然看起來是還想要有續集，但是亞瑟的故事應該是到這裡為止了。如果想看小丑發揮的話，這部電影不是個好選擇。  ","categories": ["blog"],
        "tags": ["電影","心得"],
        "url": "/blog/2025-03-watched-movies-in-2024/",
        "teaser": null
      },{
        "title": "[遊記] 2025 F1 日本大獎賽 - 行程準備",
        "excerpt":"自 2020 年入坑以來，看 F1 也進入第 6 年了。大概從前年萌生到現場看比賽的念頭，也看了一些現場觀賽的分享文後，毅然決然選定了今年的日本大獎賽。選擇日本場的原因除了日本旅遊環境友善之外，比賽舉辦的時間剛好落在清明連假，賽道當地的鈴鹿與鄰近的名古屋也是櫻花季的時期，因此這趟現地之旅就成行了。受惠於前人的分享文，所以這篇文章也來分享如何規劃行程。 門票 通常在比賽舉辦日的半年前開始售票，像今年日本大獎賽辦在 4 月初，去年 10 月中開放購票。所以在去年公布今年的賽曆之後，就開始關注售票的資訊了。購買 F1 日本大獎賽門票的管道有兩個：F1 官網與賽道方使用的 Mobility Station，雖然 F1 官網會比賽道方還要早開放售票，但是只能選區域不能選座位，而且價格也貴上許多。而賽道官網則是有限制可以購買的國家，但今年台灣可以從賽道官網購票，此外還可以選擇位置，所以我這次是透過賽道官網購票。 在開放售票前就可以先研究要買哪一區，在賽道官網上可以看到每一區的視野與影片。位置選擇的話可以考量： 視野好不好：能看到賽車經過的時間有多久，另外下層座位可能被護欄和鐵網擋到 能不能看到螢幕：鈴鹿賽道一圈約 1 分半，大約有 1 分鐘沒有賽車經過，所以能看到螢幕的話，就可以知道其它地方發生了什麼事，上面也有即時的排名與秒差。在賽道官網的視野地圖上也有標出螢幕的設置位置 超車熱點：比賽最刺激的就是看超車攻防，通常會發生在 DRS 區的尾端 我偏向超車熱點，以鈴鹿賽道來說就是大直線的尾端的 A2 區或是第 1, 2 彎的 B2 區，比賽大部份的超車都發生在這裡，也是起跑後的第一個攻防點。此外這兩個區可以完整看到賽車入彎到出彎，另外鈴鹿賽道的第 1 彎的入彎速度也很快，可以體驗到速度感。而 A2 區還可以看到賽車出 pit lane，當然這兩區的價格上也不便宜。如果有預算上的限制，在選擇上可以以能不能看到螢幕為優先選擇。 F1 舉行時會增設看臺，A2 區就是其中之一 在門票開賣那天，理所當然會湧入大量購票者，Mobility Station 也會有流量管制。但進入排隊也不用覺得沒希望，而且也可能提前進入購買頁面（顯示...","categories": ["blog"],
        "tags": ["遊記"],
        "url": "/blog/2025-05-f1-japan-grand-prix-trip-planning/",
        "teaser": "/assets/images/blog/2025/2025-05-03-f1-japan-grand-prix-trip-planning/suzuka-circuit-gp-entrance.png"
      },{
        "title": "[開發日誌 #1] 狀態機奮鬥記",
        "excerpt":"時光荏苒，參與新專案到現在也超過半年了。因為是第一次做動作遊戲，面對沒開發過的機制，看了許多資料，也踩了不少的坑，就覺得應該來寫個開發日誌，多少記錄一下開發過程的酸甜苦辣鹹。開張第一篇先來分享開發狀態機時的碰壁。      成功的經驗很棒，但失敗的經驗也值得參考啊    在新專案之前，沒想到都沒有開發過狀態機，就算有需要狀態的地方，也因為是線性流程，所以不需要用狀態機。但在動作遊戲中，狀態機是遊戲的核心，角色要狀態機，關卡流程也要狀態機，然後狀態機裡面也可能要有自己的狀態機。   狀態（轉換）機   雖然知道通常會在狀態機中執行角色的行為，但是一開始功能單純，就設計成讓狀態機專責處理狀態轉換的判斷，而狀態的執行還是在角色中：      角色會提供角色狀態（status）給狀態機判斷，狀態機中對每個狀態（state）提供不同的判斷函式，在角色中則是提供不同的執行函式。當狀態機判斷要切換狀態後，會通知角色也切換執行函式，角色執行函式就會更新角色狀態。   但當狀態開始變多與功能變複雜時，這樣的設計出現了兩個問題。第一個問題是因為狀態（state）要用到的狀態（status）都是由角色提供與更新，所以就算那個變數只是為了給某個狀態使用（像是控制一個狀態執行多久的計時器），也要宣告在角色上，造成那個變數有機會被其它狀態更新到：      另外這些類變數一多起來，管理上也不方便。   第二個問題是如果狀態中要額外做其它事會變得相當麻煩。由於判斷都是交由狀態機執行，所以狀態機判斷要做額外的事情時（像是在攻擊狀態中被打時，不轉換成硬直狀態，而是只改變一點位移），得要另外傳資料出來，因為原本狀態機回傳的資料是告知狀態轉換的資訊：      再者，用來傳遞額外資訊的物件，可能會因為每個狀態需要做不同的額外事情，而讓變數越來越多，出現與第一個問題同樣的情況。   繞了遠路   為了解決這個有問題的狀態機，就開始想：      為什麼不讓狀態判斷函式變成類別，讓它自己管理需要的變數就好？   為什麼不讓狀態執行函式自己判斷需要額外做的事情就好？   然後就想到：為什麼不直接把狀態自己的判斷跟執行函式都放在同一個類別就好？   唉呀，繞了一圈，結果還是做最典型的狀態機就好了啊：     ","categories": ["blog"],
        "tags": ["開發日誌"],
        "url": "/blog/2025-05-fight-with-state-machine/",
        "teaser": null
      },{
        "title": "[開發日誌 #2] A 需要跑步但 B 只要走路",
        "excerpt":"在這次開發的遊戲中，角色有不同的移動方式，像是玩家角色會以方向做為移動輸入，而敵人角色則是以路徑做為移動目標，而這兩者又有以距離為主的移動方式，如：瞬步、攻擊墊步。所以一開始做了通用的移動模組來整合這些方式，讓所有角色使用。但隨著敵人角色的移動方式增加，為了讓模組能保持「通用」，部份功能只能做在模組之外，造成移動方式無法集中管理。最後受不了重新設計移動模組一番，讓模組能夠為不同的角色提供各自需要的功能，又可以保持增加移動方式的彈性。 通用模組的問題 一開始通用模組設計如下圖： 通用移動模組 CharacterMovementModule 中提供不同的移動方式的子模組： 靜止的 IdleMovement 以速度向量為主的 VelocityMovement 以距離為主的 DashMovement 以路徑為主的 PathMovement 移動模組同時只會有一個子模組在執行，當子模組執行結束後（如：移動路徑走完了），會自動轉到 IdleMovement 尋路用的模組 PathFindingModule 提供用不到的功能 這是遊戲中各類角色需要的移動功能： 移動方式 玩家角色 敵人角色 NPC 靜止 :heavy_check_mark: :heavy_check_mark: :heavy_check_mark: 速度向量 :heavy_check_mark: :x: :x: 距離 :heavy_check_mark: :heavy_check_mark: :x: 路徑 :heavy_check_mark:（路徑更新一次） :heavy_check_mark:（路徑定期更新） :heavy_check_mark:（一次跟定期更新都要） 設計成通用模組的問題是，使用的角色會有用不到的功能。敵人角色用不到速度向量的移動功能，而 NPC 一樣用不到速度向量的移動功能之外，也用不到距離為主的移動功能。 不易擴充 另外從上面的表可以看到，以路徑移動的形式有兩種：只要更新一次路徑（移動到指定位置）跟定期更新路徑（持續追隨）。為了讓移動模組能「通用」，所以只提供傳入路徑再移動的功能。這時玩家角色需要實作讓尋路模組來找路徑後傳入移動模組的功能，而敵人角色則需要實作定期更新路徑的功能，然而 NPC 卻兩種形式都要，所以就得要再各實作一次一樣的功能。雖然可以把這兩種路徑移動形式連同尋路模組一起整合到移動模組內，但這樣移動模組就會相依於尋路模組，而且爾後有需要其它模組的移動方式的話，都會讓移動模組相依更多模組。如果有新的角色是不需要路徑移動方式的話，為了移動模組還要再生成尋路模組就顯得多餘了。 讓模組相依於其它模組的問題是無論用不用的到對應的模組，都得要生成依賴的模組 重構版本 這是重構後的版本：...","categories": ["blog"],
        "tags": ["開發日誌"],
        "url": "/blog/2025-06-refactor-general-module/",
        "teaser": null
      },{
        "title": "[分享] 2025 TGDF 筆記 - CDPR 篇",
        "excerpt":"今年是第三次參加 TGDF，經過兩天的英聽訓練後，才發覺自己的英聽能力一點也沒進步，低頭做完筆記後，就完全跟不上臺上講者的進度了。話雖如此，這次的 TGDF 還是收獲良多，從遊戲設計到專案管理的分享都有，對於正在參與開發的遊戲也有很大的幫助。這次的筆記就整理成 CDPR、九日、遊戲設計三篇文章。 《電馭叛客 2077》：解碼電影動畫的祕密 這場演講是 CDPR 帶來的兩場演講之一。首席電影動畫師 David Cordero Iglesias 介紹在《電馭叛客 2077》中，如何讓 NPC 更生動自然，以及更真實的第一人稱敘事運鏡，讓玩家更有沉浸感。 模擬現實互動 減少黑幕切換 NPC 在場景中會自然對話，直到玩家進來互動後，會自然結束跟其它 NPC 的對話，並轉頭過來開始跟玩家的劇情對話 利用牆面設置位置來避免玩家看到 NPC 重置的不連續感。例如：在一個追逐從後門逃跑的 NPC 的劇情中，玩家可以選擇追上去，或是從前門繞路追上他，而 NPC 一定會在暗巷中被夥伴給攔住。利用牆面的 90 度轉角，讓玩家走過牆面後，才會看到事件發生。 但遊戲中還是會為了玩家昏厥或是醒來的情境使用黑幕 玩家控制角色的能力可以分成四個層級，增強敘事能力 第一階：玩家可以自由控制角色 第二階：部份控制被限制。例如：搬重物時，移動速度變慢 第三階：只能移動視角，而且角度有限制。例如：被壓制在地上時 第四階：劇情控制，玩家完全無法操作 NPC 自然動作 NPC 的動作反應這個 NPC 的個性 NPC 在等待玩家回答時，會繼續做手邊正在做的事情，例如：吃一口飯、繼續看雜誌，而不會呆呆看著你 敘事運鏡要視野清晰 要避免 3D 暈，可以找會...","categories": ["blog"],
        "tags": ["分享"],
        "url": "/blog/2025-08-2025-tgdf-notes-01-cdpr/",
        "teaser": "/assets/images/blog/2025/2025-08-18-2025-tgdf-notes/key-visual-design.png"
      },{
        "title": "[分享] 2025 TGDF 筆記 - 九日篇",
        "excerpt":"今年《九日》相關的議程也很多，從開案時期的探索，到如何設計讓玩家能享受的遊戲機制，遊戲的設計秘辛亳無保留地分享出來。 兩年的噩夢找尋，九日類隻狼系統的誕生 這場分享《九日》是如何找到現在的類隻狼玩法，要找到突破點花了相當多的時間，其中的過程也很辛苦。 世界觀設定 「道龐克」 一個太陽對九個太陽的復仇 外星人來到地球留下了道教科技與故事 想到以動作加上銀河戰士的玩法 九個太陽所在的九個區域對應他們各自的設定 八個月就完成有基本玩法與畫面的「Hollow Cat」 但為了避免 Hollow Knight 感花了一陣子，也打掉第一版，並重新思考機制 2D 版隻狼？但慢節奏、沒 Y 軸戰鬥、沒平台挑戰 參考《Katana Zero》為了要快節奏，不加入對峙，也沒有體幹值 想要有平台挑戰，加入空中格擋 但如《Katana Zero》的快節奏，敵人看一兩次就被打倒，與隻狼要對招一兩次所帶來的深度不同 又回到類銀河的玩法上，但把體幹值改成點數制 要格擋才有氣能貼符 為了避免等格擋時機而太被動，加入普攻來算節奏 為了以格擋為主，普攻的攻擊力比貼符還要低很多 避免一直按普攻，普攻三連擊的第三下無法直接進入格擋 敵人被普攻打中後，會減攻擊 cd，讓敵人更容易主動攻擊，來讓玩家有機會格擋 加入潛行？ 2D 畫面視野很小，而且角色動很快不適合潛行，而且每個敵人也要設計暗殺動畫 最後改成「背襲」 但關卡還是有潛行的設計，如被電之後行動不便，只能潛行 貼符的體驗 貼符到懸崖邊會自動停住，避免瞬移距離過長而掉落 在地面貼符時，會先瞬步到敵人前再貼符，再繼續瞬步一段距離，但是在空中貼符則會直接貼 把技能樹當教學用 例如：點了背襲技能，知道可以背襲 大家對技能功效有不同的想像，有人想加有人不想，做成玉石系統來讓玩家自已選 如何知道找到醬汁了？成功讓玩家想要一做再做 《九日》戰鬥設計雜談 這場一樣有分享到《九日》開案時的構想，並且著重在怪物行為的設計，以及攻擊模式的小技巧，讓戰鬥更豐富。 開案起源 《返校》跟《還願》還是以華語圈為主，新作方向能否打入歐美市場？ 以玩法為核心能否有文化穿透力？像《Dead Cells》跟《Hollow Knight》...","categories": ["blog"],
        "tags": ["分享"],
        "url": "/blog/2025-08-2025-tgdf-notes-02-nine-sols/",
        "teaser": "/assets/images/blog/2025/2025-08-18-2025-tgdf-notes/key-visual-design.png"
      },{
        "title": "[分享] 2025 TGDF 筆記 - 遊戲設計篇",
        "excerpt":"這篇包含了三場演講，侍達遊戲的戰鬥設計主管分享如何設計戰鬥，而《Patrick’s Parabox》則分享開發過程與如何設計解謎遊戲，最後是 Ferran 分享音樂遊戲不只有節奏遊戲，還有更多可以探索的方向。 當敵人先出剪刀：淺談戰鬥關卡設計的四個層級與選擇引導 侍達遊戲的戰鬥設計部主管帶來的這場演講，介紹如何設計遊戲中的戰鬥，讓玩家有跡可遁而能做出對應的策略。 什麼是戰鬥設計？ 戰鬥是什麼？是勝負，像是擊敗敵人、審判攻防，甚至克服地形也可以是戰鬥 設計是什麼？有資訊讓玩家判斷如何贏，以及有對錯，玩家有輸的風險，答對則讓玩家有成就感 以剪刀石頭布為例： 1/3 隨機出拳 → 玩家不知道如何對應，不是設計 看到敵人要出剪刀 → 玩家可以選擇出石頭，是設計 看到敵人要出剪刀，但敵人很狡猾 → 玩家可以改出剪刀，是設計 所以戰鬥設計是：有勝負、有資訊（判斷他要做什麼）、有對錯（知道什麼選擇是對的） 戰鬥設計的四個層級 設計什麼：想像力是你的超能力 把非戰鬥情境變成戰鬥情境 選定戰鬥主題，例如：「按摩」 如何設計：如何表現「按摩」的戰鬥 按摩要合適的力道 → 傷害要恰當 → 每回合的傷害控制 玩法打磨：以提問建構內容 如何判斷按摩力道？傷害區間 玩家如何知道要控制力道？敵人說教，傷害太高 → 按太大力 → 「太痛了吧！」 玩家如何知道具體區間？包裝成管家指南，指示傷害值對應的力道 被按摩者會攻擊嗎？不會，現實中被按摩的人也不會打按摩師 但確立核心要避免機械解法，要避免讓玩家一直以 10% 傷害攻擊 要讓核心有變化 代入現實體驗，痠的地方要按的力一點 再發展成機制，加入傷害 buff，所以傷害要高一點 答對能對敵人造成傷害，但答錯要如何懲罰？ 錯三次才會失敗，但是有漏洞 玩家可以打兩次大傷害，再打一個成功的傷害...","categories": ["blog"],
        "tags": ["分享"],
        "url": "/blog/2025-08-2025-tgdf-notes-03-game-design/",
        "teaser": "/assets/images/blog/2025/2025-08-18-2025-tgdf-notes/key-visual-design.png"
      },{
        "title": "[開發日誌 #3] 先求有，但別繞路",
        "excerpt":"很常聽到在專案開發初期，做功能最好是「先求有，再求好」。在發覺做了兩個月的白工後，才體會到這句話的意思應該是「先求有，以此為基礎，再求好」，而不是「先求有，之後再做一個全新且更好的」。      發現白做   這次開發的遊戲中，戰鬥事件的時機跟動畫有很大的關係，像是閃避時，在哪一段時間中是無敵的，或是攻擊時，什麼時候進行傷害判定等等。在開發初期時，因為動畫還沒開始製作，所以選擇先用秒數來表達這些事件的時機點，一開始也覺得這是很直覺的作法。而隨著戰鬥規格的發展，這套參數系統也越來越複雜，最近還花了兩個月把它整理一番。    使用秒數來表達時機，指定在前幾秒的時間內，可以觸發   然而在開始套動畫之後，發覺這套以時間為主的參數系統完全無法使用。因為透過動畫趨動的事件是以開關為主，像是閃避無敵可以透過在動畫開頭開啟無敵狀態，接著在後面某個影格關閉來定義無敵的時間，或是攻擊的傷害判定時機，也可以在對應的影格上放置事件就好。    使用動畫來控制變數來表達時機，在指定變數為 true 的時候，就是可以觸發的時候   這才意識到，既然已經知道戰鬥系統會跟動畫關聯，當初就應該以動畫為基礎去製作戰鬥系統，而不是先做一個之後用不到的暫代版本。因為到頭來，花在暫代版本的時間都會白費之外，還要重做一套全新的版本。如果有其它功能是基於暫代版本去做的話，還要一併修改，也得再確認一次這些功能有沒有 bug，所花的時間不會只有開發新版本的時間。    除了開發新版本的時間，其餘都是白花的   先求有，但別繞路   所以如果知道要做的功能未來會怎樣時，最好一開始就以此為方向來開發功能，還沒有所需資料或素材就用暫代的。像戰鬥系統就算還沒有動畫，可以先用幾何形狀拉簡單示意動作，如果不用幾何形狀，也可以先把動作的時長用兩個 keyframe 簡單表示就好。因為前期的重點是把戰鬥事件實作出來，先驗證這些事件在遊戲中如何運作比較好。等到可以套上動畫之後，就可以以此為基礎，去調整事件的功能。想想如果當初就這樣做的話，就可以少花這兩個月的時間了 :cry:。  ","categories": ["blog"],
        "tags": ["開發日誌"],
        "url": "/blog/2025-08-seek-first-to-have-but-do-not-take-long-way-around/",
        "teaser": "/assets/images/blog/2025/2025-08-28-seek-first-to-have-but-do-not-take-long-way-around/cover-image.png"
      },{
        "title": "[開發日誌 #4] 原型時期的程式開發方式",
        "excerpt":"在開發遊戲原型時，最重要的是盡快實現遊戲玩法，但一開始自己走了許多歪路，反而花更多心力在不重要的地方。在 TDGF 上聽到分享與請教朋友之後，學到不少在原型階段的開發方式，就透過這篇文章來分享減少走錯路的方法。   能動就先用，不急著重構   開發時總是會想要重構程式碼，可能是因為覺得有更好的作法，或是覺得現在的架構不適合新的功能。但是在開始重構之前最好先評估要花多久，以及牽涉到的範圍有多廣。因為在原型時期的遊戲規格變動很快，如果花了大把時間重構的功能要再修改，甚至被打掉的話，花的時間就白費了（上一篇的悲慘經驗）。所以當需要增加或是修改功能時，先順著繼有的架構去作，等功能確定之後才來重構，此時的規格也比較完整，重構才有效益。   嘗試不同作法的好時機   在原型階段，程式結構還沒有很複雜，是可以嘗試用不同作法或是新套件來開發功能的好時機。可能是在之前的開發中遇到的問題有更好的作法，或是知道有不錯的套件可以使用。在這個階段多多嘗試與實驗，知道使用的作法或套件的極限到哪裡，如果不合適的話，替換掉的成本也相對低。   這次開發的遊戲為了能更方便管理與播放角色動畫，就嘗試使用 Animancer 套件來製作相關的功能。一開始我先列出想要這個套件實現的功能，然後花兩三天的時間「玩」這個套件，看看有哪些功能可以實現，哪些要自己實作，而且要花多久時間實作。評估這個套件合適後，才導入到專案中。   新內容用新功能   那如果是開發到一半，發現有更好的作法時要怎麼辦？那最好的作法是只在新的內容用新的功能，一來可以不用先花時間重構既有的功能，二來也可以驗證新的作法是不是真的比較好。如果不合適，那也只有新的內容會受到影響。如果合適的話，則在舊內容需要修改時，或是時機成熟時，像是用新作法的內容製作流程確立，再改成使用新作法，慢慢取代掉舊功能。   這次開發的遊戲中有不同的敵人，在戰鬥邏輯上就使用這樣的開發方式。原本的戰鬥邏輯是使用 ScriptableObject 來設定數值與時機，但後來為了配合角色動畫，這些資訊得改成由播放的動畫提供。所以我只有先在新的敵人上使用動畫來控制戰鬥邏輯，而既有的敵人就先不動，等到需要的時候，就直接用新功能來做擁有同樣能力的敵人，直接取代舊的敵人。   功能要有隨時被改掉的覺悟      我要修改… 部份規格!!! ー《大東京玩具箱》    在原型階段最常發生的事情就是規格改變。所以不要過度設計功能，不要想著這功能要囊括所有可能性，或是未來的需求。否則花了大把時間精心設計的功能，因為測試後覺得在遊戲中不好玩，而要被拿掉的話，只有滿滿的失落感，勞神又傷心。因此功能能解決現階段的需求就可以了，製作時間也不用花太多，先拿出來被驗證才是首要目標。   永遠考慮時間是否夠用   寫程式沒辦法兼顧「快」與「好」，在原型階段只能做取捨，就是以快速實現遊戲玩法為主要目標。所以在製作功能或是重構前，先評估要花多久時間才能完成。如果時間可以接受，就能開始動工。如果不行，就看瓶頸在哪邊，有沒有方法可以先繞過那部份，又可以掌握在可以控制的程度。再真的沒辦法，就是跟團隊討論，看能否縮減規格，或是能接受花時間下去製作。   在程式的架構設計上我以功能為單位來切割元件，一個元件（不一定只有一個程式碼檔）專門負責一個功能（一個功能下面也可能有子功能），呼叫功能的角色不用在意其中做了什麼事，只要控制什麼時候呼叫就可以了。這樣程式碼混雜的地方就只會集中在各自的元件內，無論是要替換或是修改，受影響的範圍就不大。  ","categories": ["blog"],
        "tags": ["開發日誌"],
        "url": "/blog/2025-10-programming-tips-in-prototyping-stage/",
        "teaser": null
      },{
        "title": "[遊記] Montreux Jazz Festival Japan 2025",
        "excerpt":"人生第一次參加爵士音樂節就給了 MJFJ 2025，除了為了心心念念的 Persona 5 Big Band 之外，還有著名的大師 Nate Smith 跟 Herbie Hancock 也有參演這次的音樂節。由六組表演組成長達 9 小時演出，對於初次體驗的我來說相當滿足。 前幾屆 MJFJ 的海報也有在會場內展示 今年 MJFJ 舉辦在橫濱的 PIA Arena MM，不愧是經常舉辦演唱會的日本，體驗跟在台灣完全不一樣。PIA Arena MM 場地超大音響輸出也很有力，可惜的是因為是演唱會設置，大鼓與電 Bass 的聲音太沉，而且延音很長，低頻的聲音完全混在一起，要形容的話，就是耳朵溺水，對爵士樂來說體驗差了一點。 從 2 樓看可以發覺場地真的很大 這次抽到的位置很棒，1 樓中間，也可以清楚看到舞臺上的演出 前兩團 Shuta Hasunuma Phil 與 L’Osmose 感覺都是實驗性質的音樂，弦律會持續很久，然後一直再疊不同的音色上來，最後達到最滿的狀態，讓人感覺很迷幻。 再來是 MJFJ TB×ER UNIT with BIGYUKI，薩克斯風手馬場智章是在《藍色巨星》動畫電影中，擔任角色宮本大的音樂演出，而特別來賓的鼓手石若駿同是擔任電影角色玉田俊二的音樂演出。在開始演出之前，我對他們的印象就是來自電影，但沒想到他們的音樂風格會是混和 DJ、電音、嘻哈。馬場智章會搭配錄音介面，錄製再重播上一段演奏，彷彿同時有好幾把薩克斯風同時在演奏，石若駿的演奏也相當狂野。聽下來氣氛很嗨，而且還有聽眾站起來跟著音樂一起搖擺，還以為來到音樂祭了。 馬場智章的音樂跟在電影中的風格一樣奔放...","categories": ["blog"],
        "tags": ["遊記"],
        "url": "/blog/2025-12-mjfj-2025/",
        "teaser": "/assets/images/blog/2025/2025-12-14-mjfj-2025/key-visual.png"
      }]
